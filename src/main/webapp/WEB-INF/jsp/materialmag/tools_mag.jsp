...
<script type="text/javascript">
    ...
    function output(Id){
        ...
        diag.Drag=true;
        diag.Title ="出库记录";
        diag.URL = '<%=basePath%>toolsmag/goOutput.do?id='+Id;
        diag.Width = 400;
        diag.Height = 500;
    ...
    function input(Id){
        ...
        diag.Drag=true;
        diag.Title ="入库记录";
        diag.URL = '<%=basePath%>toolsmag/goInput.do?id='+Id;
        diag.Width = 400;
        diag.Height = 500;
        diag.CancelEvent = function(){ //关闭事件
            if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
    ...
    function decrease(){
        ...
        diag.Drag=true;
        diag.Title ="出库";
        diag.URL = '<%=basePath%>toolsmag/goDecrease.do';
        diag.Width = 400;
        diag.Height = 500;
        diag.CancelEvent = function(){ //关闭事件
            if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
    ...
    function add(){
        ...
        diag.Drag=true;
        diag.Title ="入库";
        diag.URL = '<%=basePath%>toolsmag/goAdd.do';
        diag.Width = 400;
        diag.Height = 500;
        diag.CancelEvent = function(){ //关闭事件
            if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
