        ...
        <table  id="table_report" class="table table-striped table-bordered table-hover" style="width:100%;">
            <tr>
                ...
                <td><input style="width:95%;" type="text" name="mission_condition" id="mission_condition" value="${pd.mission_condition}" maxlength="200" readonly="true" title=""
                    <c:if test="${pd.mission_condition == '0' }"><span class="label label-default   arrowed-in">任务已下达</span></c:if>
                    <c:if test="${pd.mission_condition == '1' }"><span class="label label-warning   arrowed-in">拒单</span></c:if>
                    ...
                    <c:if test="${pd.mission_condition == '4' }"><span class="label label-info      arrowed-in">任务完成</span></c:if>
                    <c:if test="${pd.mission_condition == '5' }"><span class="label label-success   arrowed-in">审核通过</span></c:if>
                    <c:if test="${pd.mission_condition == '6' }"><span class="label label-danger    arrowed-in">审核未通过</span></c:if>
                    <c:if test="${pd.mission_condition == '7' }"><span class="label label-primary   arrowed-in">拒单已处理</span></c:if>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width:90px;hight:250px; text-align: right;padding-top: 13px;">执行前照片</td>
                <td ><img style="width:95%;height:250px" src="uploadFiles/uploadImgs/before_pic"></td>
                <td style="width:90px;hight:250px; text-align: right;padding-top: 13px;">执行后照片</td>
                <td ><img style="width:95%;height:250px" src="uploadFiles/uploadImgs/after_pic"></td>
            </tr>
            <tr>
                <%--从history_location表中提取--%>
                <td style="width:90px;text-align: right;padding-top: 13px;">房源经纬度</td>
                <td><input style="width:95%;" type="text" name="location" id="location" value="${pd.longitude},${pd.latitude}" maxlength="200" readonly="true" title=""/></td>
                <td style="width:90px;text-align: right;padding-top: 13px;">说明</td>
                <td><input style="width:95%;" type="text" name="note" id="note" value="${pd.note}" maxlength="200" readonly="true" title=""/></td>
            </tr>
            <tr>

                <td style="width:90px;text-align: right;padding-top: 13px;">审核人</td>
                <td><input style="width:95%;" type="text" name="auditor" id="auditor" value="${pd.USERNAME}" maxlength="200" readonly="true" title=""/></td>
                <td style="width:90px;text-align: right;padding-top: 13px;">审核意见</td>
                <td><input style="width:95%;" type="text" name="auditor_opinion" id="auditor_opinion" value="${pd.auditor_opinion}" maxlength="200" readonly="true" title=""/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width:90px;text-align: right;padding-top: 13px;">完成时间</td>
