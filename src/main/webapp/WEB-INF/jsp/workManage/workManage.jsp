...
<div class="container-fluid" id="main-container">
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            <!-- 检索  -->
            <form action="workset/list.do" method="post" name="Form" id="Form">
                <table>
                    <tr>
                        <td>
                            ...
                            <c:if test="${QX.cha == 1 }">
                                <c:forEach items="${varList}" var="var" varStatus="vs">
                                    <tr>
                                        ...
                                        <td style="width: 60px;" class="center">${var.work_id}</td>       <%--事件id--%>
                                        ...
                                        <td style="width: 100px;" class="center">${var.work_name}</td>
                                        <%--<td style="width: 150px;" class="center">${var.instrument_place}</td>--%>
                                        <td style="width: 100px;" class="center">${var.create_time}</td>
                                        <%--<td style="width: 100px;" class="center"><a class='btn btn-mini btn-info' title="查看" onclick="showQrCode('${var.qrcode}');">--%>
                                        ...
                                        <td style="width: 60px;" class="center">
                                            <div class='hidden-phone visible-desktop btn-group'>
                                                    ...
                                                    <%--编辑事件--%>
                                                <c:if test="${QX.edit == 1 }">
                                                    <c:if test="${user.USERNAME != 'admin'}"><a class='btn btn-mini btn-info' title="编辑"  onclick="edit('${var.work_id}');">
                                                ...
                                                &nbsp;&nbsp;&nbsp;
                                                <c:if test="${QX.edit == 1 }">
                                                    <c:if test="${user.USERNAME != 'admin'}"><a class='btn btn-mini btn-success' title="复制"  onclick="copy('${var.work_id}');">
                                                ...
                                                &nbsp;&nbsp;&nbsp;
                                                <c:if test="${QX.del == 1 }">
                                                    <c:if test="${user.USERNAME != 'admin'}"><a class='btn btn-mini btn-danger' title="删除" onclick="del('${var.work_id}');"  data-placement="left"><i class="icon-trash"></i> </a></c:if>
...
<script type="text/javascript">
    ...
    function add(){
        ...
        diag.Drag=true;
        diag.Title ="新增";
        diag.URL = '<%=basePath%>workset/goAddWorkContent.do';
        diag.Width = 800;
        diag.Height = 500;
        diag.CancelEvent = function(){ //关闭事件
            if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
