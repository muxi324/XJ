    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td><select name="worker_name" id="worker_name" class="form-control" value="${pd.worker_name}">
            ...
            <tr>
                ...
                <td><input style="width:90%;" type="text" name="worker_phone" id="worker_phone" value="${pd.owner_phone}" maxlength="200"  title=""/></td>
