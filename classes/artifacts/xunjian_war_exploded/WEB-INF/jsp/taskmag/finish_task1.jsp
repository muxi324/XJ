    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover" style="width:100%;">
            ...
            <tr>
                ...
                <td style="width:90px;text-align: right;padding-top: 13px;">审核结果</td>
                <td><select style="width:95%;" class="chzn-select" name="mission_condition1" id="mission_condition1" data-placeholder="" style="vertical-align:top;width: 120px;">
            ...
            <tr>
               ...
               <td>
                   <textarea rows="8" cols="40" name="auditor_opinion" id="auditor_opinion" value="${pd.auditor_opinion}"></textarea>
               </td>
            </tr>
...
//    保存
    function save(){
        if($("#mission_condition1").val()==""){
            $("#mission_condition1").tips({
                side:3,
                msg:'请选择审核结果',
                bg:'#AE81FF',
                time:2
            });
            $("#mission_condition1").focus();
            return false;
        }
        $("#Form").submit();
        $("#zhongxin").hide();
...
//重新下发任务
    function resend(Id){
        ...
        diag.Drag=true;
        diag.Title ="下发任务";
        diag.URL = '<%=basePath%>house/goSend.do?house_id='+Id;
        diag.Width = 600;
        diag.Height = 800;
